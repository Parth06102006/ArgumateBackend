import { createSpeech,voiceToText,createPoiQues,createPoiAns,conclusion } from "../controllers/speech.controller.js";
...
router.route('/create/conclusion').post(conclusion);
